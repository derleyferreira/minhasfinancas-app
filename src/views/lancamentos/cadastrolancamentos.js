...
class CadastroLancamentos extends React.Component{
    ...
    //chamado automaticamente após o render
    componentDidMount(){
    ...
    submit = () => {
        ...
        .then(response => {
            ...
            messages.mensagemSucesso("Lançamento gravado com sucesso")
        })
        .catch(error  => {
            messages.mensagemErro(error.response.data)
        })
                ...
                <div className="row">
                    <div className="col-md-6">
                        {this.state.atualizando ?
                            (
                                <button type="button" onClick={this.atualizar} className="btn btn-primary"> 
                        ...
                        <button type="button" 
                                onClick={e => this.props.history.push('/consulta-lancamentos')} className="btn btn-danger" > 
